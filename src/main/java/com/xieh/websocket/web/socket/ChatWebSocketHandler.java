...
import com.xieh.websocket.bean.ChatUser;
import com.xieh.websocket.bean.Message;
...
public class ChatWebSocketHandler implements WebSocketHandler {
	...
	public void afterConnectionEstablished(WebSocketSession webSocketSession) throws Exception {
		...
		ChatUser loginUser = (ChatUser) webSocketSession.getAttributes().get("loginUser");
		...
		for (Entry<String, WebSocketSession> entry : entrySet) {
			msg.getUserList().add((ChatUser) entry.getValue().getAttributes().get("loginUser"));
		}
